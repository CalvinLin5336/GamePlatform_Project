...
class PokerGameControllerTests {
    @Test
    void joinValidatesPlatformRoomAndLoadsPlayerFromJwt() {
        PokerGameService pokerService=mock(PokerGameService.class);
        PokerPlatformRoomService platformRoomService=mock(PokerPlatformRoomService.class);
        ...
        ReflectionTestUtils.setField(controller, "pokerPlatformRoomService", platformRoomService);
        ...
        when(platformRoomService.requireJoinableRoom("15", 2L, "player8"))
                .thenReturn(mode);
        ...
        verify(platformRoomService).requireJoinableRoom("15", 2L, "player8");
