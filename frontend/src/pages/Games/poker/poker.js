...
$(document).ready(function() {
    ...
    platformGameId=Number(getParameter("gameId"));
...
function join(mode, id) {
    ...
    if(platformRoom) {
        if(!platformGameId || !platformModeId || !platformUserId || !platformSeat) {
            showMessage("缺少遊戲或房間玩家資料", true);
            return;
        }
        body.gameId=platformGameId;
